...
import { basketState, contactsState, isContactState, selectContactsState, isAddItemState, statisticState } from '../recoil/state';
        ...
        <Page name="write" >
            ...
            <Icon ios="f7:xmark" aurora="f7:xmark" md="material:close"></Icon>
                <FabButtons position="top">
                    <FabButton label="상품 제거하기"><a href="/admin/delete-item"><Icon ios="f7:xmark_square" aurora="f7:xmark_square"></Icon></a></FabButton>
                    <FabButton label="상품 등록하기"><a href="/admin/create-item"><Icon ios="f7:cube" aurora="f7:cube"></Icon></a></FabButton>
                </FabButtons>
            </Fab>

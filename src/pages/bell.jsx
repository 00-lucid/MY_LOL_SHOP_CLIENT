import { Button, f7ready, Page, Navbar, Swiper, SwiperSlide, Toolbar, Block, NavTitle, List, ListItem, NavRight, Link, Icon, Subnavbar, Segmented, Tab, Tabs } from 'framework7-react';
        ...
        <Tabs>
            <Tab id="tab1" tabActive className="page-content">
                <List className="overflow-scroll">
                    {   bells.length > 0 &&
                        bells.map((bell, idx) => <ListItem key={idx} title={bell.text} header={bell.createdAt} style={{
                            backgroundColor: '#02111b'}}/>)
                    }
                    {/* <ListItem title="활동알림1"  style={{
                        backgroundColor: '#02111b'
                    }}></ListItem> */}
                </List>
            </Tab>
